<form action="<?php echo wp_login_url(); ?>" method="post" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
        <div class="u-form-group u-form-name">
          ...
          <input type="text" placeholder="<?php _e( 'Username' ); ?>" id="username-a30d" name="log" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
        </div>
        <div class="u-form-group u-form-password">
          <label for="password-a30d" class="u-label" name=""><?php _e( 'Password' ); ?></label>
          <input type="password" placeholder="<?php _e( 'Password' ); ?>" id="password-a30d" name="pwd" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
        </div>
        ...
        <div class="u-align-left u-form-group u-form-submit">
          <a href="#" class="u-btn u-btn-submit u-button-style"><?php _e( 'Log in' ); ?></a>
