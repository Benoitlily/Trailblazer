<?php $skip_min_height = false; ?><section class="u-align-center u-clearfix u-section-1" id="sec-5f49">
...
c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path></svg>
        ...
        <div class="u-product-control u-product-price u-product-price-1" data-add-zero-cents="true">
          <div class="u-price-wrapper u-spacing-10"><!--product_old_price-->
            <div class="u-hide-price u-old-price" style="text-decoration: line-through !important;"><?php echo $productData['price_old']; ?></div><!--/product_old_price--><!--product_regular_price-->
        ...
        <div class="u-align-left u-product-control u-product-desc u-text u-text-2"><?php echo $productData['shortDesc']; ?></div><!--/product_content--><!--product_button--><!--options_json--><!--{"clickType":"go-to-page","content":""}--><!--/options_json-->
        <a href="<?php echo $productData['productUrl']; ?>" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-product-control u-text-black u-text-hover-white u-btn-1 u-dialog-link u-payment-button" data-product-button-click-type="go-to-page" data-product-id="<?php echo $productId; ?>" data-product="<?php echo $productJson; ?>"><!--product_button_content-->Add to Cart<!--/product_button_content--></a><!--/product_button-->
      </div>
