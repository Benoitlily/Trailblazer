...
--custom-color-1: #f7a217;
--custom-color-1-darker: #eb9508;
--custom-color-1-r: 247;
...
--custom-color-2: #9f6404;
--custom-color-2-darker: #8f5a04;
--custom-color-2-r: 159;
--custom-color-2-g: 100;
--custom-color-2-b: 4;
--custom-color-2-contrast: white;
--custom-color-2-contrast-darker: white;
--custom-color-2-text-color: var(--body-alt-color);
--custom-color-3: #a3040b;
--custom-color-3-darker: #93040a;
--custom-color-3-r: 163;
--custom-color-3-g: 4;
--custom-color-3-b: 11;
